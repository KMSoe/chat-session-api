...
<body>
    ...
    <div style="max-width: 640px;margin: 0 auto;">
        <div class="body-div"
            ...
            text-align: center;">
                {{-- <img src="{{ asset('email_images/logo.png') }}" alt="VORP logo" style="margin: 0px auto;" /> --}}
            </div>
            <div style="margin: 0 30px;">
                <table bgColor="white" align="center" valign="middle" border="0"
                            ...
                            <table width="100%" class="no-padding-table" bgColor="white" align="center" valign="middle"
                                ...
                                <tr>
                                    <td style="padding:0 36px;padding-top: 26px;text-align: center;">
                                        {{-- <img width="80" height="80" src="{{ asset('email_images/Confetti 2.png') }}"
                                            alt="teenyicons_password" /> --}}
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table class="no-padding-table" bgColor="white" align="left" valign="middle" border="0"
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p style="font-size: 18px;color: #1B3757;"><b>Reset Password</b></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td style="padding:0 36px;">
                                        <p class="custom-text"
                                            ...
                                            You are receiving this email because we have received a <b>password reset request </b>for your account.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding:0 36px;">
                                        <div class="me-email-browse-product">
                                            <a href="{{ $reset_password_link }}" style="font-size: 16px;font-weight: bold;color: #363848;display: inline-block;
                    ...
                    <tr>
                        <td>
                            <table class="no-padding-table" bgColor="white" align="left" valign="middle" border="0" style="width: 100%;border-radius: 12px;">
                                <tr>
                                    <td style="padding-left:36px;padding-right: 36px;padding-bottom: 36px;">
                                        <p style="margin-top: 0px; font-size: 12px;line-height: normal;font-style: italic;
                                    font-weight: normal;
                                    color: #363848;">
                                    If you're having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser:<a href="{{ $reset_password_link }}" style="white-space: normal;word-break: break-all;text-decoration: underline;color: #363848;">{{ $reset_password_link }}</a></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <div style="background-color: #464E5F;max-width: 640px;margin: 0 auto;padding-top: 2px;">
        ...
        padding: 32px 36px;">
            ...
            text-align: center;
            margin-top: 0;
            margin-bottom: 0;">©{{ now()->year }} {{ config('app.name', '') }}. All rights reserved.</p>
        </div>
    </div>
</body>
