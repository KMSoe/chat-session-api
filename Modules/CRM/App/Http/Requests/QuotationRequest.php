...
class QuotationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return[
            ...
            'quotation_number' => $isUpdate ? ['nullable', 'string', Rule::unique('quotations', 'quotation_number')->ignore($this->quotation)->whereNull('deleted_at')]
                    : ['required', 'string', Rule::unique('quotations', 'quotation_number')->whereNull('deleted_at')],
            'reference_number' => 'nullable|string|max:255',
            'quotation_date' => $isUpdate ? 'nullable|date' : 'required|date',
            ...
            'taxation_level' => $isUpdate ? ['nullable', Rule::in(['item', 'quote'])] : ['required', Rule::in(['item', 'quote'])],
            'discount_level' => $isUpdate ? ['nullable', Rule::in(['item', 'quote'])] : ['required', Rule::in(['item', 'quote'])],
            ...
            'quotation_status' => $isUpdate ? ['nullable', Rule::in(['draft', 'pending_approval', 'save_and_send'])] : ['required', Rule::in(['draft', 'pending_approval', 'save_and_send'])],
        ];
    }
